...
export default function Taxi() {
  return (
    <>
      <main className="flex flex-col md:flex-row justify-center gap-6 ">
        <section className="flex flex-col justify-center items-center md:w-[50%] w-[100%] bg-white ">
        ...
        <section className="md:w-[50%] w-[100%] min-h-[100%] ">
          <img
            src="/Taxi.jpg"
            width={"100%"}
            height={"100%"}
